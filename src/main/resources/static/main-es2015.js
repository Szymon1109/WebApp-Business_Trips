...
const config = new ng4_social_login__WEBPACK_IMPORTED_MODULE_20__["AuthServiceConfig"]([
    {
...
let AuthService = class AuthService {
    ...
    authenticationSocialService(email) {
        this.setItems(email, "", "true");
    }
    setItems(email, password, socialLogin) {
...
let DelegationService = class DelegationService {
    ...
    findByEmailAndConfirmation(isConfirmed) {
    ...
    findNotRequestedByEmailAndConfirmation(isConfirmed) {
        this.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
            'Authorization': this.authService.getBasicAuthToken()
        });
    ...
    findRequestedByEmailAndConfirmation(status) {
        this.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
            'Authorization': this.authService.getBasicAuthToken()
        });
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set("status", status.toString());
    ...
    findFutureByEmail() {
        ...
        let email = this.authService.getEmailLogged();
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set("email", email.toString());
...
let ConfirmationRequestPanelComponent = class ConfirmationRequestPanelComponent {
    ...
    loadDelegations() {
        this.delegationService.findRequestedByEmailAndConfirmation(true).subscribe(data => {
...
ConfirmationRequestPanelComponent.ctorParameters = () => [
...
let EditDelegationPanelComponent = class EditDelegationPanelComponent {
    constructor(userService, delegationService) {
    ...
    loadDelegations(email) {
        this.delegationService.findAllByEmail(email).subscribe(data => {
            this.delegations = data;
        });
    }
    edit() {
...
EditDelegationPanelComponent.ctorParameters = () => [
...
let RemoveDelegationPanelComponent = class RemoveDelegationPanelComponent {
    constructor(userService, delegationService) {
        this.userService = userService;
        this.delegationService = delegationService;
...
RemoveDelegationPanelComponent.ctorParameters = () => [
...
let RemoveUserPanelComponent = class RemoveUserPanelComponent {
...
RemoveUserPanelComponent.ctorParameters = () => [
...
let UnconfirmationRequestPanelComponent = class UnconfirmationRequestPanelComponent {
    constructor(delegationService) {
        this.delegationService = delegationService;
    ...
    loadDelegations() {
        this.delegationService.findRequestedByEmailAndConfirmation(false).subscribe(data => {
            this.delegations = data;
        });
    }
    unconfirm() {
...
UnconfirmationRequestPanelComponent.ctorParameters = () => [
    { type: _delegation_service_delegation_service__WEBPACK_IMPORTED_MODULE_2__["DelegationService"] }
];
...
let UserAdminPanelComponent = class UserAdminPanelComponent {
    constructor(userService) {
        this.userService = userService;
    ...
    loadUsers() {
        this.userService.findAllNotAdmins().subscribe(data => {
            this.users = data;
        });
    }
    makeAdmin() {
...
UserAdminPanelComponent.ctorParameters = () => [
    { type: _user_service_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"] }
];
...
let AddPanelComponent = class AddPanelComponent {
    constructor(delegationService) {
        this.delegationService = delegationService;
...
AddPanelComponent.ctorParameters = () => [
    { type: _delegation_service_delegation_service__WEBPACK_IMPORTED_MODULE_2__["DelegationService"] }
];
...
let ConfirmedListPanelComponent = class ConfirmedListPanelComponent {
    constructor(delegationService, authService) {
        this.delegationService = delegationService;
        this.authService = authService;
        this.loadDelegations();
    }
    ...
    loadDelegations() {
        this.delegationService.findByEmailAndConfirmation(true).subscribe(data => {
    ...
    pdf(del) {
        let doc = new jspdf__WEBPACK_IMPORTED_MODULE_4__();
        let email = this.authService.getEmailLogged();
...
ConfirmedListPanelComponent.ctorParameters = () => [
    { type: _delegation_service_delegation_service__WEBPACK_IMPORTED_MODULE_2__["DelegationService"] },
    { type: _auth_service_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] }
];
...
let EditDelegPanelComponent = class EditDelegPanelComponent {
    constructor(delegationService) {
        this.delegationService = delegationService;
    ...
    loadDelegations() {
        this.delegationService.findFutureByEmail().subscribe(data => {
            this.delegations = data;
        });
    }
    edit() {
...
EditDelegPanelComponent.ctorParameters = () => [
    { type: _delegation_service_delegation_service__WEBPACK_IMPORTED_MODULE_3__["DelegationService"] }
];
...
let RemoveDelegPanelComponent = class RemoveDelegPanelComponent {
    constructor(delegationService) {
        this.delegationService = delegationService;
...
RemoveDelegPanelComponent.ctorParameters = () => [
    { type: _delegation_service_delegation_service__WEBPACK_IMPORTED_MODULE_2__["DelegationService"] }
];
...
let RequestConfirmationPanelComponent = class RequestConfirmationPanelComponent {
    constructor(delegationService) {
        this.delegationService = delegationService;
    ...
    loadDelegations() {
        this.delegationService.findNotRequestedByEmailAndConfirmation(false).subscribe(data => {
            this.delegations = data;
        });
    }
    request() {
...
RequestConfirmationPanelComponent.ctorParameters = () => [
    { type: _delegation_service_delegation_service__WEBPACK_IMPORTED_MODULE_2__["DelegationService"] }
];
...
let RequestUnconfirmationPanelComponent = class RequestUnconfirmationPanelComponent {
    constructor(delegationService) {
        this.delegationService = delegationService;
    ...
    loadDelegations() {
        this.delegationService.findNotRequestedByEmailAndConfirmation(true).subscribe(data => {
            this.delegations = data;
        });
    }
    request() {
...
RequestUnconfirmationPanelComponent.ctorParameters = () => [
    { type: _delegation_service_delegation_service__WEBPACK_IMPORTED_MODULE_2__["DelegationService"] }
];
...
let UnconfirmedListPanelComponent = class UnconfirmedListPanelComponent {
    constructor(delegationService, authService) {
        this.delegationService = delegationService;
        this.authService = authService;
        this.loadDelegations();
    ...
    loadDelegations() {
        this.delegationService.findByEmailAndConfirmation(false).subscribe(data => {
            this.delegations = this.editData(data);
        });
    }
    editData(array) {
...
UnconfirmedListPanelComponent.ctorParameters = () => [
    { type: _delegation_service_delegation_service__WEBPACK_IMPORTED_MODULE_2__["DelegationService"] },
    { type: _auth_service_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] }
];
...
let ChangePwdPanelComponent = class ChangePwdPanelComponent {
    constructor(userService, authService) {
        this.userService = userService;
        this.authService = authService;
...
ChangePwdPanelComponent.ctorParameters = () => [
    { type: _user_service_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"] },
    { type: _auth_service_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] }
];
...
let EditProfilePanelComponent = class EditProfilePanelComponent {
    constructor(userService) {
        this.userService = userService;
...
EditProfilePanelComponent.ctorParameters = () => [
    { type: _user_service_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"] }
];
...
let LoginComponent = class LoginComponent {
    constructor(route, router, myAuthService, socialAuthService, userService) {
        this.route = route;
        this.router = router;
    ...
    socialLogin(service) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (service == "google") {
                yield this.socialAuthService.signIn(ng4_social_login__WEBPACK_IMPORTED_MODULE_4__["GoogleLoginProvider"].PROVIDER_ID).then(user => {
                    this.socialUser = user;
                });
            }
            else if (service == "facebook") {
                yield this.socialAuthService.signIn(ng4_social_login__WEBPACK_IMPORTED_MODULE_4__["FacebookLoginProvider"].PROVIDER_ID).then(user => {
                    this.socialUser = user;
                });
            }
...
class Delegation {
    constructor(description, dateTimeStart, dateTimeStop, travelDietAmount, breakfastNumber, dinnerNumber, supperNumber, transport, ticketPrice, autoCapacity, distance, accommodationPrice, otherTicketsPrice, otherOutlayDesc, otherOutlayPrice) {
...
class User {
    constructor(name, lastName, email, password, companyName, companyAddress, companyNip) {
        this.name = name;
...
let UserService = class UserService {
    ...
    findAllUsers() {
        ...
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set("name", "USER");
